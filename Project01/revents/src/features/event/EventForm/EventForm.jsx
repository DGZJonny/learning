...
class EventForm extends Component {
  ...
  onInputChange = (e) =>{
      const newEvent = this.state.event // gets the values of the inputs that contain this method on the onChange
      newEvent[e.target.name] = e.target.value; // allows values to be changed to their specific field.
      
      //the new state of the inputs
      this.setState({
            event: newEvent
      }); 
  }
